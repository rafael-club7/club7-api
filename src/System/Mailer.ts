class Mailer{
    ...
    static ConfirmaCadastro(link){
        const mail = {
            titulo: "Club7 - Bem vindo!",
            email: ''
        };
        ...
        mail.email += `               <h2 style="border:none;margin:0px;padding:0px;text-decoration:none;color:rgb(0, 0, 0);font-size:40px;font-weight:bold;line-height:45px;letter-spacing:-0.04em;text-align:center;">Muito bem vindo ao Club7!</h2>`;
        mail.email += `               <p style="font-size: 25px;"> Para continuar seu cadastro, <a href="${link}">Clique aqui</a> para receber todos os nossos benefícios! </p>`;
        mail.email += `           </div>`;
    ...
    static ConfirmacaoAssinaturaCartao(){
        const mail = {
            titulo: "Club7 - Assinatura Confirmada!",
            email: ''
        };
        ...
        mail.email += `           <div style="width: 80%; height: 200px; background-color:white; text-align: center; padding: 25px 10%">`;
        mail.email += `               <h2 style="border:none;margin:0px;padding:0px;text-decoration:none;color:rgb(0, 0, 0);font-size:40px;font-weight:bold;line-height:45px;letter-spacing:-0.04em;text-align:center;">Você solicitou uma nova senha?</h2>`;
        mail.email += `               <p style="font-size: 25px;"> Obrigado </p>`;
        mail.email += `           </div>`;
        mail.email += `           <div style="max-width:100%; min-height: 30px; background-color: #F7F7F7; padding: 5px 0 5px 20px">`;
        mail.email += `               <p style="color: #88898C; font-size: 20px;"><b>Lead</b>This</p>`;
        mail.email += `               <p><small style="color: #ddd;">by LeadThis - 2020</small></p>`;
    ...
    static ConfirmacaoAssinaturaBoleto(){
        const mail = {
            titulo: "Club7 - Assinatura Confirmada!",
            email: ''
        };
